...
RUN apt-get update \
    ...
    && apt-get update \
    && apt-get install -y php7.0-fpm php7.0-cli php7.0-dev php7.0-common \
       ...
       php7.0-gd php7.0-imap php-memcached php7.0-sqlite3 php7.0-xdebug \
